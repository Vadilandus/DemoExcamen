...
--
-- Хост: localhost
-- Время создания: Сен 12 2024 г., 10:37
...
INSERT INTO `comments` (`id`, `master_id`, `message`) VALUES
(1, 2, 'Интересно...'),
(2, 3, 'Будем разбираться!'),
(3, 3, 'Сделаем всё на высшем уровне!');
...
INSERT INTO `requests` (`request_id`, `startDate`, `type_id`, `orgTechModel`, `problemDescryption`, `status_id`, `completionDate`, `repairParts`, `master_id`, `customer_id`) VALUES
(1, '2023-06-06 00:00:00.000000', 1, 'DEXP Aquilon O286', 'перестал работать', 2, 'null', '', 2, 7),
(2, '2023-05-05 00:00:00.000000', 1, 'DEXP Atlas H388', 'Перестал работать', 2, 'null', '', 3, 8),
(3, '2022-07-07 00:00:00.000000', 2, 'MSI GF76 Katana 11UC-879XRU черный', 'Выключается', 1, '2023-01-01', '', 3, 9),
(4, '2023-08-02 00:00:00.000000', 2, 'MSI Modern 15 B12M-211RU черный', 'Выключается', 3, 'null', '', 11, 8),
(5, '2023-08-02 00:00:00.000000', 3, 'HP LaserJet Pro M404dn', 'Перестала включаться', 3, 'null', '', 11, 9);
...
(1, 'ready', 'Готова к выдаче'),
(2, 'todo', 'В процессе ремонта'),
(3, 'wait', 'Новая заявка');
...
ALTER TABLE `requests`
  ...
  ADD CONSTRAINT `requests_ibfk_5` FOREIGN KEY (`master_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `requests_ibfk_6` FOREIGN KEY (`customer_id`) REFERENCES `user` (`id`);
